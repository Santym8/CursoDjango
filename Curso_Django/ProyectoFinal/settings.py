...
SECRET_KEY = 'xa0koesf54t2%k*jm_-u983a-%$%yk#k!9g$_iiw65d78o)74a'
...
INSTALLED_APPS = [
    ...
    'proyecto_final_app',               #Simpre añadir una nueva app una vez creada
    'servicios_app',
    'blog_app',
    'contacto_app',
]
...
MEDIA_URL='/media/'                                                                 #Crear una carpeta 'media' antes 
...
EMAIL_HOST_PASSWORD = "Santympruebas88"